...
const Sidebar: React.FC<{
  ...
  const navItems = [
    ...
    {
      icon: <DollarSign className="w-5 h-5 text-main" />,
      label: "Payments",
      path: "/coordinator/payments",
    },
    // { icon: <MessageCircle className="w-5 h-5 text-main" />, label: 'Chats', path: '/coordinator/chats' },
    // { icon: <User className="w-5 h-5 text-main" />, label: 'My Profile', path: '/coordinator/profile' },
  ];
