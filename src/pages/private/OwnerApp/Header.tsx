...
import { clearSchool } from "../../../features/schoolSlice";
...
const Header: React.FC = () => {
  ...
  const school = useSelector((state: RootState) => state.auth.user);
                  ...
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative bg-white dark:bg-gray-800">
                      <div className="p-2">
                        ...
                        {/* <Link to="/owner/notification-settings" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
                          <Bell className="w-4 h-4 mr-2" />
                          Notification Settings
                        </Link> */}
                        {/* <Link to="/owner/support" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
