...
const Header: React.FC = () => {
  const user = useSelector((state: RootState) => state.auth.user) as Teacher;
  ...
  const handleLogout = async () => {
    try {
      const response = await api.post("/teachers/logout");
                ...
                <PopoverPanel className="absolute right-0 z-10 mt-2 w-56 transform">
                  <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="relative bg-white dark:bg-gray-950">
                      <div className="p-2">
                        {/* <Link to="/instructor/notification-settings" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
                        ...
                        {/* <Link to="/instructor/support" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
