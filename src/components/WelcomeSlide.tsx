...
const Welcome: React.FC<WelcomeProps> = ({ username = "" }) => {
  return (
    <div className="w-full min-h-screen flex justify-center items-center bg-blue-50 dark:bg-gray-950">
      <motion.div
      ...
      >
        <div className="flex items-center">
          <WaveHandEmoji />
          <span className="text-xl md:text-5xl font-bold text-gray-800 dark:text-gray-50">
            Welcome
          </span>
          <span className="text-xl md:text-5xl font-bold text-gray-800 dark:text-gray-50">
            ! {username}
