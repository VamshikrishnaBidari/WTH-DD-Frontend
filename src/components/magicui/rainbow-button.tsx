  ...
  return (
    <button
      ...
      className={cn(
        ...
        // 6
        // light and dark mode colors using contraYellow
        "bg-[linear-gradient(theme(colors.contraYellow),theme(colors.contraYellow))]",
        "dark:bg-[linear-gradient(theme(colors.contraYellow),theme(colors.contraYellow))]",
